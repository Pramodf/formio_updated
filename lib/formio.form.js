                              ...
                              for(var k = 0 ; k < _this11.component.components.length; k++) {
                                  if(_this11.component.components[k].id === value) {
                                      for(var i = 0; i < _this11.component.components[k].components[0].components.length; i++) {
                                        ...
                                        {
                                          if(_this11.component.components[0].components[0].components[i]["validate"].hasOwnProperty("required")
                                            && _this11.component.components[0].components[0].components[i]["validate"]["required"] === true)
                                          {
                                            validationObj.isRequired = true;
                                          }
                                          if(_this11.component.components[0].components[0].components[i]["validate"].hasOwnProperty("min")
                                          && _this11.component.components[0].components[0].components[i]["validate"]["min"] !== null)
                                          {
                                            validationObj.minVal = _this11.component.components[0].components[0].components[i]["validate"]["min"];
                                          }

                                          if(_this11.component.components[0].components[0].components[i]["validate"].hasOwnProperty("max")
                                          && _this11.component.components[0].components[0].components[i]["validate"]["max"] !== null)
                                          {
                                            validationObj.maxVal = _this11.component.components[0].components[0].components[i]["validate"]["max"];
                                          }

                                          if(_this11.component.components[0].components[0].components[i]["validate"].hasOwnProperty("pattern")
                                          && _this11.component.components[0].components[0].components[i]["validate"]["pattern"] !== null)
                                          {
                                            validationObj.pattern = _this11.component.components[0].components[0].components[i]["validate"]["pattern"];
                                          }
