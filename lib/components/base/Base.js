	...
	}, 
	{
		...
		value: function enableDisableAnnotationBtns() {
			...
			if (this.data) {
				...
				} else if(formData.hasOwnProperty(measureOptionalKey) && currentFormData[measureOptionalKey] === true) {
					$('.optionalSectionBtn').prop('disabled', false);
					$('.mandatorySectionBtn').prop('disabled', true);
					$('.numeratorSectionBtn').prop('disabled', true);
				} else if((formData.hasOwnProperty(measureMandaotoryKey) && currentFormData[measureMandaotoryKey] === false)
										&& (formData.hasOwnProperty(measureOptionalKey) && currentFormData[measureOptionalKey] === false)){
