    ...
    value: function fieldLogic(data) {
      ...
      var changed = logics.reduce(function (changed, logic) {
        ...
        return changed;
			...
			// checkbox enable/disabled case handling
			if(resultval === false && this.originalComponent.type === "checkbox" && this.component.disabled === true  
					&& this !== undefined && this.originalComponent !== undefined){
				this.component.disabled = false;
				changed = true;
			} else  if(resultval === true && this.originalComponent.type === "checkbox" && this.originalComponent.disabled === false  
			&& this !== undefined && this.originalComponent !== undefined){
