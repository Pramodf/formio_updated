...
var DateTimeComponent = exports.DateTimeComponent = function (_BaseComponent) {
  ...
  //   }
	...
	// mode: this.component.multiple ? 'multiple' : 'single',
        ...
        onOpen: function onOpen(selectedDates, dateStr, calender, e) {
          calender.config.isManual = false;
        },
        ...
        onReady: function onReady(selectedDates, dateStr, calender) {
          ...
          calender._input.addEventListener("keydown", function(e){
  ...
  {
    key:"onBlur",
    value: function onBlur(selectedDates, dateStr, calender, e) {
      if(!calender.config.isManual)
        return;
