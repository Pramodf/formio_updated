...
var NumberComponent = exports.NumberComponent = function (_BaseComponent) {
  ...
  _createClass(NumberComponent, [{
    ...
    value: function elementInfo() {
      ...
      // MRR-9098: add semantic validation for input number field & number length is configurable from global.ts
      info.attr.maxlength = window.chartNavCompRef.component.GLOBALS.NumberInputFieldMaxLength;
